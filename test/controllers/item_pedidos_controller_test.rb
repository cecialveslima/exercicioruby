...
class ItemPedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_pedido" do
    assert_difference("ItemPedido.count") do
      post item_pedidos_url, params: { item_pedido: { idPedido: @item_pedido.idPedido, idProd: @item_pedido.idProd, qtdItem: @item_pedido.qtdItem } }
    end
  ...
  test "should update item_pedido" do
    patch item_pedido_url(@item_pedido), params: { item_pedido: { idPedido: @item_pedido.idPedido, idProd: @item_pedido.idProd, qtdItem: @item_pedido.qtdItem } }
