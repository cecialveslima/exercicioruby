...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { codMar: @produto.codMar, dscProd: @produto.dscProd, idCat: @produto.idCat, idProd: @produto.idProd, qtd: @produto.qtd, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { codMar: @produto.codMar, dscProd: @produto.dscProd, idCat: @produto.idCat, idProd: @produto.idProd, qtd: @produto.qtd, valor: @produto.valor } }
