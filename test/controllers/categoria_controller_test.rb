...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference("Categorium.count") do
      post categoria_url, params: { categorium: { dscCat: @categorium.dscCat, idCat: @categorium.idCat, idDpto: @categorium.idDpto } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { dscCat: @categorium.dscCat, idCat: @categorium.idCat, idDpto: @categorium.idDpto } }
