class CategoriaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categorium.save
        format.html { redirect_to categorium_url(@categorium), notice: "Categoria criada com sucesso" }
  ...
  def update
    respond_to do |format|
      if @categorium.update(categorium_params)
        format.html { redirect_to categorium_url(@categorium), notice: "Categoria alterada com sucesso" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to categoria_url, notice: "Categoria excluída com sucesso" }
  ...
  private
    ...
    def categorium_params
      params.require(:categorium).permit(:idCat, :dscCat, :idDpto)
    end
end
